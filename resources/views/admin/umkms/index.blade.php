...
@can('umkm_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('admin.umkms.create') }}">
...
<div class="card">
    <div class="card-header">
        {{ trans('cruds.umkm.title_singular') }} {{ trans('global.list') }}
    </div>

    <div class="card-body">
        <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-Umkm">
            <thead>
                <tr>
                    <th width="10">
                ...
                <tr>
                    ...
                    <td>
                        <select class="search">
                            ...
                            @foreach($contact_details as $key => $item)
...
@can('umkm_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('admin.umkms.massDestroy') }}",
...
{ data: 'actions', name: '{{ trans('global.actions') }}' }
  ...
  let table = $('.datatable-Umkm').DataTable(dtOverrideGlobals);
