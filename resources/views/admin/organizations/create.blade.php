...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.organizations.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label for="photos">{{ trans('cruds.organization.fields.photos') }}</label>
                ...
                @endif
                <span class="help-block">{{ trans('cruds.organization.fields.photos_helper') }}</span>
            </div>
            <div class="form-group">
...
Dropzone.options.photosDropzone = {
    ...
    init: function () {
@if(isset($organization) && $organization->photos)
      var files = {!! json_encode($organization->photos) !!}
          for (var i in files) {
          var file = files[i]
